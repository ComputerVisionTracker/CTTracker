...
int main(int argc, char * argv[])
{
	...
	while (true)
	{
		...
		ct.processFrame(mGrayFrame, mBox);
	...
	double time = ((double)getTickCount() - mTick) / getTickFrequency();
...
//double calculateFPS(int mIndex);
//
//int main(int argc, char * argv[])
//{
//	initVideoData();
...
void openStream()
{
	out.open(mVideoData[mVideoNumber].name + ".txt", ios::out);
}
